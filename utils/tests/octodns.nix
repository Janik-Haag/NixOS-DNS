  ...
  testFakeSOA = {
    expr = utils.octodns.fakeSOA {
      "example.com" = {
        ...
        "host3.example.com" = {
          a = { data = [ "198.51.100.3" ]; ttl = 86400; };
          aaaa = { data = [ "2001:db8:d9a2:5198::3" ]; ttl = 86400; };
        };
        "host4.example.com" = {
    ...
    expected = {
      "example.com" = {
        "example.com" = {
          ns = { data = [ "ns1.invalid" "ns2.invalid" "ns3.invalid" ]; ttl = 60; };
          soa = { data = [{ expire = 1209600; mname = "ns.example.invalid"; refresh = 7200; retry = 3600; rname = "admin.example.invalid"; serial = 1970010100; ttl = 60; }]; ttl = 60; };
        };
        "host1.example.com" = {
          a = { data = [ "198.51.100.1" ]; ttl = 86400; };
          aaaa = { data = [ "2001:db8:d9a2:5198::1" ]; ttl = 86400; };
